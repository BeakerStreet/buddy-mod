...
UPDATE AiFavoredItems SET Value = 50 WHERE ListType = 'MilitaryVictoryPseudoYields' AND Item = 'PSEUDOYIELD_NUCLEAR_WEAPON'; -- def. 25 (pvs 55)
UPDATE AiFavoredItems SET Value = -80 WHERE ListType = 'MilitaryVictoryPseudoYields' AND Item = 'PSEUDOYIELD_CITY_ORIGINAL_CAPITAL'; -- def. 100
UPDATE AiFavoredItems SET Value = -30 WHERE ListType = 'MilitaryVictoryPseudoYields' AND Item = 'PSEUDOYIELD_CITY_DEFENSES'; -- def. -25
UPDATE AiFavoredItems SET Value = -29 WHERE ListType = 'MilitaryVictoryPseudoYields' AND Item = 'PSEUDOYIELD_CITY_DEFENDING_UNITS'; -- def. -25
...
('MilitaryVictoryPseudoYields', 'PSEUDOYIELD_DIPLOMATIC_VICTORY_POINT', 0, -80),
('MilitaryVictoryPseudoYields', 'PSEUDOYIELD_DIPLOMATIC_GRIEVANCE', 1, -30); -- Def -0.5
