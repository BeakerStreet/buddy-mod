...
('CultureCivYieldBoost', 'YIELD_CULTURE', 1, 8), -- pvs 4, 5, 6
('CultureCivYieldBoost', 'YIELD_SCIENCE', 1, -1),
('CultureCivYieldBoost', 'YIELD_PRODUCTION', 1, -2),
('CultureCivYieldBoost', 'YIELD_GOLD', 1, 2), -- Trade
('CultureCivYieldBoost', 'YIELD_FAITH', 1, 3),

('CultureCivPseudoBoost', 'PSEUDOYIELD_TOURISM', 1, 40), -- pvs 22, 26, 35, 37
('CultureCivPseudoBoost', 'PSEUDOYIELD_CIVIC', 1, 8),
('CultureCivPseudoBoost', 'PSEUDOYIELD_WONDER', 1, 15),
('CultureCivPseudoBoost', 'PSEUDOYIELD_HAPPINESS', 1, 15), -- pvs 11, 12

('CultureCivPseudoBoost', 'PSEUDOYIELD_GPP_GENERAL', 1, -15),
('CultureCivPseudoBoost', 'PSEUDOYIELD_GPP_PROPHET', 1, 5),
('CultureCivPseudoBoost', 'PSEUDOYIELD_GPP_MERCHANT', 1, 7),
...
('CultureCivPseudoBoost', 'PSEUDOYIELD_GPP_WRITER', 1, 21), -- pvs 10, 18
...
INSERT OR IGNORE INTO AiFavoredItems (ListType, Item, Favored, Value) VALUES
('CultureCivBuildings', 'BUILDING_MONUMENT', 1, 20),
('CultureCivBuildings', 'BUILDING_COLOSSEUM', 1, 100);
...
DELETE FROM AiFavoredItems WHERE ListType = 'FavorReligiousVictory' AND Item = 'VICTORY_STRATEGY_RELIGIOUS_VICTORY'; -- Disabling for now
...
('ReligionCivYieldBoost', 'YIELD_FAITH', 1, 17), -- pvs 5, 8, 10, 12, 17

('ReligionCivPseudoBoost', 'PSEUDOYIELD_GPP_PROPHET', 1, 25), -- pvs 10, 15
--('ReligionCivPseudoBoost', 'PSEUDOYIELD_DIPLOMATIC_BONUS', 1, 2),
('ReligionCivPseudoBoost', 'PSEUDOYIELD_UNIT_RELIGIOUS', 1, 35), -- pvs 35
('ReligionCivPseudoBoost', 'PSEUDOYIELD_RELIGIOUS_CONVERT_EMPIRE', 1, 40), -- pvs 8, 7
('ReligionCivPseudoBoost', 'PSEUDOYIELD_GREATWORK_RELIC', 1, 5);
...
UPDATE StrategyConditions SET ThresholdValue = '2' WHERE StrategyType="VICTORY_STRATEGY_RELIGIOUS_VICTORY" AND ConditionFunction = 'Good Faith City'; -- def 1
...
('ScienceCivYieldBoost', 'YIELD_SCIENCE', 1, 4), -- pvs 1
...
('ScienceCivPseudoBoost', 'PSEUDOYIELD_GPP_SCIENTIST', 1, 20),
('ScienceCivPseudoBoost', 'PSEUDOYIELD_GPP_ENGINEER', 1, 10),
