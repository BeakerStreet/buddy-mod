...
('JadwigaYields', 'YIELD_GOLD', 1, 10),
('JadwigaYields', 'YIELD_FAITH', 1, 5), -- Extra Faith because of Saint Agenda and Holy Site Bonus
...
('JadwigaPseudoYields', 'PSEUDOYIELD_GPP_PROPHET', 1, 20), -- Holy sites extra adj bonus, 1 instead of 0.5 from districts
('JadwigaPseudoYields', 'PSEUDOYIELD_GPP_MERCHANT', 1, 25), -- Sukiennice
...
('JadwigaPseudoYields', 'PSEUDOYIELD_GPP_GENERAL', 1, 25), 
('JadwigaPseudoYields', 'PSEUDOYIELD_IMPROVEMENT', 1, 6), -- For forts?
('JadwigaPseudoYields', 'PSEUDOYIELD_GREATWORK_RELIC', 1, 70),
...
UPDATE AiFavoredItems SET Value = 25 WHERE ListType = 'JadwigaUnitBuilds' AND Item = 'UNIT_MILITARY_ENGINEER'; -- def 1 lol
