...
('PersiaUnits', 'UNIT_PERSIAN_IMMORTAL', 1, 15),
...
('MacedonUnits', 'TRAIT_CIVILIZATION_UNIT_HYPASPIST', 'Units'),
('AlexanderUnitBuilds',   'TRAIT_LEADER_TO_WORLDS_END', 'UnitPromotionClasses');

INSERT OR IGNORE INTO AiFavoredItems (ListType, Item, Favored, Value) VALUES

('AlexanderYields', 'YIELD_SCIENCE', 1, 7), -- Military Units -- Iron Working
('AlexanderYields', 'YIELD_FAITH', 0, -40),

('AlexanderTechs', 'TECH_MINING', 1, 0), -- Military Units -- Leads to Bronze and then Iron Working

('MacedonUnits', 'UNIT_MACEDONIAN_HYPASPIST', 1, 20),
('MacedonUnits', 'UNIT_MACEDONIAN_HETAIROI', 1, 10), -- Alex Only

('AlexanderPseudoYields', 'PSEUDOYIELD_CITY_BASE', 1, 80), -- eurekas 

('AlexanderPseudoYields', 'PSEUDOYIELD_HAPPINESS', 1, -8), -- No War Weariness
('AlexanderPseudoYields', 'PSEUDOYIELD_DIPLOMATIC_GRIEVANCE', 1, -60), -- Grievances against this leader decay at twice the usual rate. / likes civs at war 
...
('AlexanderPseudoYields', 'PSEUDOYIELD_GPP_GENERAL', 1, 20), -- encampment buildings, special unit
