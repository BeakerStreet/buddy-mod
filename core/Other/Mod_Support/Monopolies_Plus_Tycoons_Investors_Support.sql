...
('UnitPriorityBoosts', 'UNIT_LEU_INVESTOR', 45), 
('UnitPriorityBoosts', 'UNIT_LEU_TYCOON',   45); 
...
INSERT OR REPLACE INTO AiFavoredItems (ListType, Item, Value) VALUES
('CultureVictoryYields', 'YIELD_GOLD', 		 10), 
('CultureVictoryYields', 'YIELD_PRODUCTION', 10);
...
INSERT OR REPLACE INTO AiFavoredItems (ListType, Item, Value) VALUES
('CultureVictoryPseudoYields', 'PSEUDOYIELD_GPP_MERCHANT', 50),
('CultureVictoryPseudoYields', 'PSEUDOYIELD_RESOURCE_LUXURY', 50);

INSERT OR REPLACE INTO AiFavoredItems (ListType, Item, Favored, Value) VALUES
('CultureVictoryUnits', 'UNIT_LEU_TYCOON', 1, 40),
('CultureVictoryUnits', 'UNIT_LEU_INVESTOR', 1, 40);
...
('CultureVictorySettlement', 'Resource Class',        0, 15, 'RESOURCECLASS_LUXURY'); -- base 2
