...
INSERT OR IGNORE INTO MajorStartingUnits (Unit, Era, AiOnly, District, Quantity, NotStartTile, OnDistrictCreated, MinDifficulty, DifficultyDelta)
VALUES ('UNIT_WARRIOR', 'ERA_ANCIENT', 1, 'DISTRICT_CAMPUS', 1, 0, 1,  'DIFFICULTY_DEITY', 0.5);


-- Deity Builder at Campus to make up for deleted or delayed Warriors

INSERT OR IGNORE INTO MajorStartingUnits (Unit, Era, AiOnly, District, Quantity, NotStartTile, OnDistrictCreated, MinDifficulty, DifficultyDelta)
VALUES ('UNIT_BUILDER', 'ERA_ANCIENT', 1, 'DISTRICT_CAMPUS', 1, 0, 1,  'DIFFICULTY_DEITY', 0.5);


-- Adjusted

-- Deity 3 Warriors, 3 Settlers, 2 Builders (1 Warrior, 1 Scout and 1 Builder on 1st Campus Only, 1 Warrior on 2nd Campus)
-- Immortal 2 Warriors, 2 Settlers, 2 Builders (1 Warrior and Scout on 1st Campus)
-- Emperor 2 Warriors, 2 Settlers, 1 Builder
...
-- Defs Emperor 3 Warriors, 2 Settlers, 1 Builder
...
INSERT OR IGNORE INTO Modifiers
		...
		('RH_AI_IMPROVEMENT_DELETED_WAR1_DEITY',								'MODIFIER_SINGLE_CITY_GRANT_UNIT_IN_NEAREST_CITY',		'RH_AI_HAS_CURRENCY_REQ_S_DEITY'),
		('RH_AI_IMPROVEMENT_DELETED_WAR3_DEITY',								'MODIFIER_SINGLE_CITY_GRANT_UNIT_IN_NEAREST_CITY',		'RH_AI_HAS_SHIPBUILDING_REQ_S_DEITY'),
...
INSERT OR IGNORE INTO ModifierArguments
		...
		('RH_AI_IMPROVEMENT_DELETED_WAR3_DEITY',								'Amount',					2),
...
INSERT OR IGNORE INTO RequirementSetRequirements
		...
		('RH_AI_HAS_MACHINERY_REQ_S_DEITY',									'REQUIRES_PLAYER_EMPEROR_RH');
		--
