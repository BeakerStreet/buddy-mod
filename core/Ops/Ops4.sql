...
--------------------------------------------------------------------------------------------------------------------------
-- RH Ops 4 -- Simple Attack Force, Defence -- Special Thanks - Infixo
--------------------------------------------------------------------------------------------------------------------------
...
UPDATE OpTeamRequirements SET MinNumber = 1, MaxNumber = 8 WHERE TeamName = 'Simple Early Attack Force' AND AiType = 'UNITAI_COMBAT'; -- MinNumber=1
UPDATE OpTeamRequirements SET MaxNumber = 4 WHERE TeamName = 'Simple Early Attack Force' AND AiType = 'UNITTYPE_RANGED'; -- Max Def 3, pvs 4 (Min 0)
...
-- Bar
--UPDATE OpTeamRequirements SET MaxNumber = 0 WHERE TeamName = 'Simple Early Attack Force' AND AiType = 'UNITTYPE_CIVILIAN'; -- Already Exists
...
UPDATE OpTeamRequirements SET MinNumber = 0, MaxNumber = 5 WHERE TeamName = 'Simple City Attack Force' AND AiType = 'UNITTYPE_RANGED'; -- Def 3
...
UPDATE AiOperationDefs SET MustHaveUnits = 2 WHERE OperationName = 'City Defense'; -- 0%, -1 -- pvs 3 (and 0.01) -- MinOddsOfSuccess = 0.01, 

UPDATE OpTeamRequirements SET MinNumber = 2, MaxNumber = 8 WHERE TeamName = 'City Defense' AND AiType = 'UNITAI_COMBAT'; --testing 6
...
UPDATE OpTeamRequirements SET MinNumber = 0, MaxNumber = 2 WHERE TeamName = 'City Defense' AND AiType = 'UNITTYPE_AIR'; -- def max 0, pvs 4
UPDATE OpTeamRequirements SET MinNumber = 0, MaxNumber = 0 WHERE TeamName = 'City Defense' AND AiType = 'UNITTYPE_AIR_SIEGE'; -- def max 0 -- reduced now to 0 to give more bombers to nuclear op

INSERT OR IGNORE INTO OpTeamRequirements (TeamName, AiType, MinNumber, MaxNumber, MinPercentage, MaxPercentage) VALUES
('City Defense', 'UNITTYPE_MELEE',  0, 6, 0, 1); -- (can be 2 as long as there are 4 units)

INSERT OR IGNORE INTO OpTeamRequirements (TeamName, AiType, MinNumber, MaxNumber) VALUES
('City Defense', 'UNITTYPE_RANGED', 							  1, 7), 
('City Defense', 'UNITTYPE_NUCLEAR', 							  0, 0),
('City Defense', 'UNITTYPE_ANTIAIR_SUPPORT', 					  0, 0), -- test
...
INSERT OR IGNORE INTO OpTeamRequirements (TeamName, AiType, MinPercentage, MaxPercentage) VALUES
('City Defense', 'UNITTYPE_ANTIAIR_SUPPORT', 	0, 0.45),
('City Defense', 'UNITTYPE_NAVAL_MELEE', 		0, 0),
...
INSERT OR IGNORE INTO OpTeamRequirements (TeamName, AiType, MinPercentage, MaxPercentage) VALUES
('City Naval Defense', 'UNITTYPE_ANTIAIR_SUPPORT', 	0, 0.4),
('City Naval Defense', 'UNITTYPE_CIVILIAN_LEADER',	 0, 0.25);


UPDATE OpTeamRequirements SET MinNumber = 0, MaxNumber = 8 WHERE TeamName = 'City Naval Defense' AND AiType = 'UNITTYPE_MELEE'; 
...
('Naval Sup Melee Force', 'UNITTYPE_NAVAL_MELEE',       2, 5),
...
('BaseOperationsLimits',   'OP_AIR_DEFENSE', 15); -- pvs 10, 7
...
INSERT OR IGNORE INTO AiOperationDefs (OperationName,TargetType,TargetParameter, MinOddsOfSuccess,		BehaviorTree,		Priority,	MaxTargetDistInRegion,MaxTargetDistInArea,MaxTargetDistInWorld,MustHaveUnits,OperationType) VALUES 
		('Air City Defense OP',				'TARGET_FRIENDLY_CITY',				1, 0,		'RH City Air Defense Tree',	4,		-1,						-1,					-1,						1,'OP_AIR_DEFENSE'); -- op name is spelt incorrectly
