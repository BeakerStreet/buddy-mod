...
UPDATE AiOperationTeams SET OngoingStrengthAdvantage = '-800' WHERE TeamName = 'Nuclear Attack' AND OperationName = 'Nuclear Assault'; -- def '0' -- Check constraint failed?
UPDATE AiOperationTeams SET InitialStrengthAdvantage = '-800' WHERE TeamName = 'Nuclear Attack' AND OperationName = 'Nuclear Assault';  -- testing -900 instead of -9 def -1
