...
-- def 2, 4
UPDATE AiOperationTeams SET InitialStrengthAdvantage = 0.3, OngoingStrengthAdvantage = 0.8 WHERE TeamName = 'City Attack Force' AND OperationName = 'Wartime Attack Walled City';
-- def 1, 6


UPDATE OpTeamRequirements SET MinNumber = 6, MaxNumber = 14 WHERE TeamName = 'City Attack Force' AND AiType = 'UNITAI_COMBAT'; -- Def MinNumber=5 MaxNumber=16, increasing from 14 to 15 -- back to 6
UPDATE OpTeamRequirements SET MinNumber = 3, MaxNumber = 8 WHERE TeamName = 'City Attack Force' AND AiType = 'UNITTYPE_MELEE'; -- pvs 5, 6, 5, pvs min 2
UPDATE OpTeamRequirements SET MinNumber = 1, MaxNumber = 6 WHERE TeamName = 'City Attack Force' AND AiType = 'UNITTYPE_RANGED'; -- pvs 6 --def min 1
...
UPDATE OpTeamRequirements SET MinNumber = 2, MaxNumber = 4 WHERE TeamName = 'City Attack Force' AND AiType = 'UNITTYPE_SIEGE'; -- Max back to 4 (reduced to 1 as the AI will have multiple ops running at the same time)
...
('City Attack Force', 'UNITTYPE_ANTIAIR_SUPPORT',      0, 0); -- only antiair guns, pvs 0
...
('City Attack Force', 'UNITTYPE_SIEGE_ALL', 0, 0.6),
('City Attack Force', 'UNITTYPE_RANGED', 0, 0.75),
...
UPDATE AiOperationTeams SET InitialStrengthAdvantage = -6, OngoingStrengthAdvantage = 1.4 WHERE TeamName = 'City Naval Attack Force' AND OperationName = 'Attack Enemy City'; 
-- def -5, 2
UPDATE AiOperationTeams SET InitialStrengthAdvantage = -8, OngoingStrengthAdvantage = 0.5 WHERE TeamName = 'City Naval Attack Force' AND OperationName = 'Wartime Attack Enemy City';
-- def -5, 2
...
('City Naval Attack Force', 'UNITTYPE_AIR_SIEGE', 			 0, 1),
...
UPDATE  AiOperationTeams SET TeamName = 'Walled City Naval Attack Force', InitialStrengthAdvantage = -5, OngoingStrengthAdvantage = 1.6 WHERE OperationName = 'Attack Walled City'         AND Condition = 'IsCoastalTarget';
UPDATE  AiOperationTeams SET TeamName = 'Walled City Naval Attack Force', InitialStrengthAdvantage = -6, OngoingStrengthAdvantage = 1.2 WHERE OperationName = 'Wartime Attack Walled City' AND Condition = 'IsCoastalTarget';
-- def -5, 3
-- bugged with same name by default


INSERT OR IGNORE INTO OpTeamRequirements (TeamName,AiType,MinNumber,MaxNumber) VALUES
('Walled City Naval Attack Force', 'UNITAI_COMBAT',           6, 15); -- pvs min 7

INSERT OR IGNORE INTO OpTeamRequirements (TeamName,AiType,MinNumber,MaxNumber,MinPercentage,MaxPercentage) VALUES
('Walled City Naval Attack Force', 'UNITTYPE_SIEGE_ALL',       0, 4, 0, 0.7);
...
('Walled City Naval Attack Force', 'UNITTYPE_CIVILIAN_LEADER', 0, 2, 				0, 0.25), -- def doesn't exist
...
('Walled City Naval Attack Force', 'UNITTYPE_NUCLEAR',         0, 1, 				0, 0.25),
...
INSERT OR IGNORE INTO OpTeamRequirements (TeamName,AiType,MinNumber,MaxNumber) VALUES
('Walled City Naval Attack Force', 'UNITTYPE_ANTIAIR_SUPPORT',      0, 0); -- not for naval attacks
...
INSERT OR IGNORE INTO OpTeamRequirements (TeamName,AiType,MinNumber,MaxNumber) VALUES
('Aid Ally Attack Force', 'UNITAI_COMBAT',       			 1, 15), -- def doesn't exist
