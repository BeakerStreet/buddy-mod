...
('Nuclear Attack', 'UNITTYPE_AIR_SIEGE',        0, 4), 
...
UPDATE AiOperationDefs SET Priority = '4', MaxTargetDistInRegion = '-1', MaxTargetDistInArea = '12', MaxTargetDistInWorld = '12', MinOddsOfSuccess = '0.4', MustHaveUnits = '5' WHERE OperationName = 'Attack Enemy City' AND TargetType = 'TARGET_ENEMY_COMBAT_DISTRICT';
UPDATE AiOperationDefs SET Priority = '4', MaxTargetDistInRegion = '-1', MaxTargetDistInArea = '12', MaxTargetDistInWorld = '13', MinOddsOfSuccess = '0.2', MustHaveUnits = '4' WHERE OperationName = 'Wartime Attack Enemy City' AND TargetType = 'TARGET_ENEMY_COMBAT_DISTRICT'; 
UPDATE AiOperationDefs SET Priority = '4', MaxTargetDistInRegion = '-1', MaxTargetDistInArea = '16', MaxTargetDistInWorld = '15', MinOddsOfSuccess = '0.5', MustHaveUnits = '7' WHERE OperationName = 'Attack Walled City' AND TargetType = 'TARGET_ENEMY_COMBAT_DISTRICT'; -- pvs 0.5 -- def must have units is 10
UPDATE AiOperationDefs SET Priority = '3', MaxTargetDistInRegion = '-1', MaxTargetDistInArea = '22', MaxTargetDistInWorld = '21', MinOddsOfSuccess = '0.3', MustHaveUnits = '6' WHERE OperationName = 'Wartime Attack Walled City' AND TargetType = 'TARGET_ENEMY_COMBAT_DISTRICT'; 


UPDATE AiOperationDefs SET Priority = '3', MinOddsOfSuccess = '0.33', MaxTargetDistInArea ='23' WHERE OperationName = 'Attack Barb Camp' AND TargetType = 'TARGET_BARBARIAN_CAMP';
...
UPDATE OpTeamRequirements SET MinNumber = '1', MaxNumber = '2' WHERE TeamName = 'Settle City Team' AND AiType = 'UNITAI_COMBAT'; -- MinNumber=1	MaxNumber=, max pvs 3
...
UPDATE AiOperationDefs SET Priority = '3', MaxTargetDistInRegion = '-1', MaxTargetDistInArea = '45' WHERE OperationName = 'Aid Ally' AND TargetType = 'TARGET_ALLY_SUPPORT'; -- Priority = 3	MaxTargetDistInRegion = -1	MaxTargetDistInArea = 45	MinOddsOfSuccess = 0	MustHaveUnits = -1
